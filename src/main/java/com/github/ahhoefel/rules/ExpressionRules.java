...
public class ExpressionRules {
    ...
    public void provideRules(Rule.Builder rules, Language lang) {
        ...
        List<List<Pair<Rule, Symbol>>> precendence = List.of(List.of(new Pair<>(memberAccessRule, lex.period)),
                ...
                List.of(new Pair<>(lessThan, lex.lessThan), new Pair<>(lessThanOrEqual, lex.lessThanOrEqual),
                        new Pair<>(greaterThan, lex.greaterThan),
                        new Pair<>(greaterThanOrEqual, lex.greaterThanOrEqual)),
                List.of(new Pair<>(doubleAmpersand, lex.doubleAmpersand), new Pair<>(doublePipe, lex.doublePipe)));

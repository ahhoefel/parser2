...
public class Language {
  ...
  public Language() {
    ...
    expression = symbols.newSymbol("expression");
    functionInvocation = symbols.newSymbol("functionInvocation");
    argList = symbols.newSymbol("argList");
    argument = symbols.newSymbol("argument");

    List<Rule> rules = new ArrayList<>();
    rules.add(new Rule(nonTerminals.getStart(), List.of(expression)));

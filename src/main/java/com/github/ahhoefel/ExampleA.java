...
public class ExampleA {
    public static void main(String[] args) {
        ...
        LRTable table = new LRTable(Arrays.asList(
                new LRTable.State(Map.of(), Map.of(num, 8, id, 9), Map.of(sums, 1, products, 4, value, 7)),
                new LRTable.State(Map.of(), Map.of(plus, 2, eof, -1), Map.of()),
                new LRTable.State(Map.of(), Map.of(num, 8, id, 9), Map.of(products, 3, value, 7)),
                new LRTable.State(Map.of(plus, r1, eof, r1), Map.of(times, 5), Map.of()),
                new LRTable.State(Map.of(plus, r2, eof, r2), Map.of(times, 5), Map.of()),
                new LRTable.State(Map.of(), Map.of(num, 8, id, 9), Map.of(value, 6)),
        ...
        // nonTerminals.getAugmentedStart());
        // System.out.println(tree);

        table = LRParser.getSLRTable(grammar);
        System.out.println(table);
        // tree = Parser.parseTerminals(table, input.iterator(),
        // nonTerminals.getAugmentedStart());
        // System.out.println(tree);
    }
}

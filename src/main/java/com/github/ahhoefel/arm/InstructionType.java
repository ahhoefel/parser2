...
public class InstructionType {
        ...
        public static final InstructionType MUL = new InstructionType("MUL", ParameterType.X, ParameterType.X,
                        ParameterType.X);
        public static final InstructionType MUL_IMM = new InstructionType("MUL", ParameterType.X, ParameterType.X,
                        ParameterType.UINT_12);
        ...
        // public static final InstructionType STR = new InstructionType("STR",
        // ParameterType.X, ParameterType.LABEL);
        ...
        public static final InstructionType COMMENT = new InstructionType("COMMENT", ParameterType.COMMENT);
        ...
        public boolean validParams(List<Parameter> params) {
                ...
                if (params.size() != paramTypes.size() && params.size() - 1 != paramTypes.size()) {
                        return false;
                }
                ...
                return params.size() - 1 != paramTypes.size()
                                || ParameterType.COMMENT.matches(params.get(params.size() - 1));
        }
